    ...
    <div class="aplicacoes-grid">
      ...
      <article class="aplicacao-card animate-on-scroll delay-1" aria-labelledby="aplic1-title">
        <div class="aplicacao-img-wrap">
          ...
          -->
          <div class="aplicacao-img-placeholder" style="background:linear-gradient(135deg,#1e3a5f,#0f172a);" role="img" aria-label="Aplicação em fachadas">
      ...
      <article class="aplicacao-card animate-on-scroll delay-2" aria-labelledby="aplic2-title">
        <div class="aplicacao-img-wrap">
          ...
          -->
          <div class="aplicacao-img-placeholder" style="background:linear-gradient(135deg,#1a3a1f,#0f1a0d);" role="img" aria-label="Aplicação em paredes internas">
      ...
      <article class="aplicacao-card animate-on-scroll delay-3" aria-labelledby="aplic3-title">
        <div class="aplicacao-img-wrap">
          ...
          -->
          <div class="aplicacao-img-placeholder" style="background:linear-gradient(135deg,#3a1a0a,#1a0a05);" role="img" aria-label="Aplicação em áreas externas">
      ...
      <article class="aplicacao-card animate-on-scroll delay-1" aria-labelledby="aplic4-title">
        <div class="aplicacao-img-wrap">
          ...
          -->
          <div class="aplicacao-img-placeholder" style="background:linear-gradient(135deg,#1a1a3a,#0a0a1e);" role="img" aria-label="Aplicação em obras residenciais">
      ...
      <article class="aplicacao-card animate-on-scroll delay-2" aria-labelledby="aplic5-title">
        <div class="aplicacao-img-wrap">
          ...
          -->
          <div class="aplicacao-img-placeholder" style="background:linear-gradient(135deg,#1a3a2a,#0a1e15);" role="img" aria-label="Aplicação em obras comerciais">
      ...
      <article class="aplicacao-card animate-on-scroll delay-3" aria-labelledby="aplic6-title">
        <div class="aplicacao-img-wrap">
          ...
          -->
          <div class="aplicacao-img-placeholder" style="background:linear-gradient(135deg,#2a1a3a,#150a1e);" role="img" aria-label="Aplicação em porcelanatos de grande formato">
      ...
      <form id="lead-form" novalidate aria-label="Formulário de contato e orçamento">
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-bottom:20px;">
          <div>
            ...
            <input type="text" id="nome" name="nome" required placeholder="Seu nome" 
              ...
              onfocus="this.style.borderColor='#e8751a'" onblur="this.style.borderColor='#e5e7eb'">
          </div>
          <div>
        ...
        <div style="margin-bottom:28px;">
          ...
          <textarea id="mensagem" name="mensagem" rows="4" placeholder="Descreva o seu projeto, quantidade necessária, prazo, etc." 
            ...
            onfocus="this.style.borderColor='#e8751a'" onblur="this.style.borderColor='#e5e7eb'"></textarea>
        </div>
